...
struct Z_Construct_UClass_ATP3ShootCharacter_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ParticleStart_MetaData[] = {
		{ "Category", "Gameplay" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/*\n\x09// Add a gun skeletal mesh component\n\x09UPROPERTY(BlueprintReadWrite, VisibleDefaultsOnly, Category = Mesh)\n\x09""class AGun_Rifle* Gun;*/// Particle Start\n" },
#endif
		{ "ModuleRelativePath", "TP3ShootCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "// Add a gun skeletal mesh component\nUPROPERTY(BlueprintReadWrite, VisibleDefaultsOnly, Category = Mesh)\nclass AGun_Rifle* Gun;// Particle Start" },
#endif
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_thoma_Documents_Unreal_Projects_TP3_ShooterAI_TP3_ShooterAI_Reset_TP3ShootStarter_TP3ShootStarter_Source_TP3Shoot_TP3ShootCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATP3ShootCharacter, ATP3ShootCharacter::StaticClass, TEXT("ATP3ShootCharacter"), &Z_Registration_Info_UClass_ATP3ShootCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATP3ShootCharacter), 1771021045U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_thoma_Documents_Unreal_Projects_TP3_ShooterAI_TP3_ShooterAI_Reset_TP3ShootStarter_TP3ShootStarter_Source_TP3Shoot_TP3ShootCharacter_h_2482639195(TEXT("/Script/TP3Shoot"),
	Z_CompiledInDeferFile_FID_Users_thoma_Documents_Unreal_Projects_TP3_ShooterAI_TP3_ShooterAI_Reset_TP3ShootStarter_TP3ShootStarter_Source_TP3Shoot_TP3ShootCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_thoma_Documents_Unreal_Projects_TP3_ShooterAI_TP3_ShooterAI_Reset_TP3ShootStarter_TP3ShootStarter_Source_TP3Shoot_TP3ShootCharacter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
